          ...
          <div className="landing-hero">
            ...
            <div className="landing-community">
              ...
              <div className="community-links">
                ...
                >
                  <svg className="community-logo" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link 
                  ...
                  className="community-link"
                >
                  <svg className="community-logo" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
